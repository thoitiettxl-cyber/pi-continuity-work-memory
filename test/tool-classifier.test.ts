...
test("ordinary shell, Git, and GitHub discovery remains read-only", () => {
	for (const command of [
		...
		"gh gist list",
		"gh gist view 817bf03433e059bf89c63dc33f286ccb",
		"curl -fsSL https://gist.githubusercontent.com/tmatz/817bf03433e059bf89c63dc33f286ccb/raw",
		"curl -fsSL --url https://gist.github.com/tmatz/817bf03433e059bf89c63dc33f286ccb",
		"curl -fsSL 'https://gist.github.com/tmatz/817bf03433e059bf89c63dc33f286ccb?permalink_comment_id=6209999#gistcomment-6209999'",
		"wget -q -O - https://gist.githubusercontent.com/tmatz/817bf03433e059bf89c63dc33f286ccb/raw",
		"node /root/.pi/agent/skills/summarize/to-markdown.mjs 'https://gist.github.com/tmatz/817bf03433e059bf89c63dc33f286ccb?permalink_comment_id=6209999#gistcomment-6209999' --tmp",
...
test("executable, output-writing, mutating, and credential-revealing command forms stay external", () => {
	for (const command of [
		...
		"gh gist delete 817bf03433e059bf89c63dc33f286ccb",
		"gh gist view 817bf03433e059bf89c63dc33f286ccb --web",
		"curl -fsSL https://example.invalid/document",
		"curl -o /tmp/gist.md https://gist.githubusercontent.com/tmatz/817bf03433e059bf89c63dc33f286ccb/raw",
		"curl -X POST https://gist.github.com/tmatz/817bf03433e059bf89c63dc33f286ccb",
		"curl -H 'Authorization: Bearer secret-value' https://gist.github.com/tmatz/817bf03433e059bf89c63dc33f286ccb",
		"wget https://gist.githubusercontent.com/tmatz/817bf03433e059bf89c63dc33f286ccb/raw",
		"node /root/.pi/agent/skills/summarize/to-markdown.mjs https://gist.github.com/tmatz/817bf03433e059bf89c63dc33f286ccb --summary",
		"node /root/.pi/agent/skills/summarize/to-markdown.mjs https://gist.github.com/tmatz/817bf03433e059bf89c63dc33f286ccb --out /tmp/gist.md",
		"node /tmp/to-markdown.mjs https://gist.github.com/tmatz/817bf03433e059bf89c63dc33f286ccb --tmp",
		"gh run rerun 123",
