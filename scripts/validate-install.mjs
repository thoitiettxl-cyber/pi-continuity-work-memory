...
const pi = existsSync(piCandidate) ? piCandidate : "pi";
...
function copyInstallPayload() {
	...
	for (const relative of ["package.json", "README.md", "LICENSE", "dist", "scripts/validate-provider.mjs", "scripts/validate-alpine-arm64.sh", "proof/ACCEPTANCE.md", "proof/RESULTS.json"]) {
